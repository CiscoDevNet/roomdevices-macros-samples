...
function updateMainLayout(){
  ...
  console.log('updateMainLayout.Main-sources: ' + JSON.stringify(mainSources) + ' Layout:' + layoutfamily_main + ' PipSize:' + layoutfamily_pipsize + ' PipPosition:' + layoutfamily_pipposition);
...
function removeFromMainList(mainSource){
  ...
  if (index > -1) {
    ...
    xapi.command("UserInterface Extensions Widget SetValue", {'WidgetId': 'main_source_' + mainSource, 'Value':'off'});
    console.log('removeFromMainList. Main-sources: ' + JSON.stringify(mainSources));
  }
    ...
    if(match){
        switch(match[1]){
            ...
            case 'main_source_':
                ...
                console.log('main_source_handler: Main-sources: ' + JSON.stringify(mainSources));
             //   previewSelfViewAfterLayoutChange();
